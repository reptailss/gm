...
class CreateAppEnvModule {
    ...
    create() {
        ...
        if (this.config.hasStaticSql) {
            res.push({ key: 'INIT_SQL_STATIC_DB_DIALECT', value: this.getEnvValue('INIT_SQL_STATIC_DB_DIALECT') }, { key: 'INIT_SQL_STATIC_DB_ENCODING', value: this.getEnvValue('INIT_SQL_STATIC_DB_ENCODING') }, { key: 'INIT_SQL_STATIC_DB_TIMEZONE', value: this.getEnvValue('INIT_SQL_STATIC_DB_TIMEZONE') });
        }
        if (this.config.hasStructureAccess) {
            res.push({ key: 'INIT_USE_STRUCTURE_ACCESS', value: this.getEnvValue('INIT_USE_STRUCTURE_ACCESS') });
        }
        if (this.config.hasAws) {
            res.push({ key: 'INIT_AWS_S3_BUCKET', value: this.getEnvValue('INIT_AWS_S3_BUCKET') }, { key: 'INIT_AWS_S3_REGION', value: this.getEnvValue('INIT_AWS_S3_REGION') }, { key: 'INIT_AWS_S3_ACCESS_KEY', value: this.getEnvValue('INIT_AWS_S3_ACCESS_KEY') }, { key: 'INIT_AWS_S3_SECRET_KEY', value: this.getEnvValue('INIT_AWS_S3_SECRET_KEY') }, { key: 'INIT_HAS_AWS_S3_UPLOAD', value: this.getEnvValue('INIT_HAS_AWS_S3_UPLOAD') });
        }
