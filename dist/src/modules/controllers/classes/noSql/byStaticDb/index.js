...
exports.GmModuleControllerClassGetAllByNoSqlStaticDb = exports.GmModuleControllerClassGetByNoSqlStaticDb = exports.GmModuleControllerClassDeleteByNoSqlStaticDb = exports.GmModuleControllerClassUpdateByNoSqlStaticDb = exports.GmModuleControllerClassCreateByNoSqlStaticDb = exports.GmModuleControllerClassCrudByNoSqlStaticDb = void 0;
...
const byStaticDb_1 = require("../../../../services/classes/noSql/byStaticDb");
...
class GmModuleControllerClassCrudByNoSqlStaticDb extends GmModuleAbstractControllerClass_1.GmModuleAbstractControllerClass {
    constructor(config) {
        ...
        const gmGetVarNames = new GmGetVarNamesByStaticDb(config);
        this.serviceCrud = new byStaticDb_1.GmModuleServiceClassCrudByNoSqlStaticDb(config, `this.${this.getServiceVarName()}`, {
            create: {
...
exports.GmModuleControllerClassCrudByNoSqlStaticDb = GmModuleControllerClassCrudByNoSqlStaticDb;
class GmModuleControllerClassCreateByNoSqlStaticDb extends GmModuleAbstractControllerClass_1.GmModuleAbstractControllerClass {
    constructor(config) {
        super(config, `Create${StringCaseHelper_1.StringCaseHelper.toPascalCase(config.dtoName.singular)}Controller`);
        this.validator = new GmModuleValidator_1.GmModuleValidator(config);
        this.gmValidatorBuilder = new GmValidatorBuilderByStaticDb(config, this.validator);
        const gmGetVarNames = new GmGetVarNamesByStaticDb(config);
        this.serviceCrud = new byStaticDb_1.GmModuleServiceClassCreateByNoSqlStaticDb(config, `this.${this.getServiceVarName()}`, {
            createDto: gmGetVarNames.add().createBody,
            initiatorOpenUserId: gmGetVarNames.add().openUserId,
        });
        this.gmAccessStructureMethodProcessorByStaticDb = new GmAccessStructureMethodProcessorByStaticDb(config);
...
exports.GmModuleControllerClassCreateByNoSqlStaticDb = GmModuleControllerClassCreateByNoSqlStaticDb;
class GmModuleControllerClassUpdateByNoSqlStaticDb extends GmModuleAbstractControllerClass_1.GmModuleAbstractControllerClass {
    constructor(config) {
        super(config, `Update${StringCaseHelper_1.StringCaseHelper.toPascalCase(config.dtoName.singular)}Controller`);
        this.validator = new GmModuleValidator_1.GmModuleValidator(config);
        this.gmValidatorBuilder = new GmValidatorBuilderByStaticDb(config, this.validator);
        const gmGetVarNames = new GmGetVarNamesByStaticDb(config);
        this.serviceCrud = new byStaticDb_1.GmModuleServiceClassUpdateByNoSqlStaticDb(config, `this.${this.getServiceVarName()}`, {
            id: gmGetVarNames.update().id,
            updateDto: gmGetVarNames.update().updateBody,
            initiatorOpenUserId: gmGetVarNames.update().openUserId,
        });
...
exports.GmModuleControllerClassUpdateByNoSqlStaticDb = GmModuleControllerClassUpdateByNoSqlStaticDb;
class GmModuleControllerClassDeleteByNoSqlStaticDb extends GmModuleAbstractControllerClass_1.GmModuleAbstractControllerClass {
    constructor(config) {
        super(config, `Delete${StringCaseHelper_1.StringCaseHelper.toPascalCase(config.dtoName.singular)}Controller`);
        const gmGetVarNames = new GmGetVarNamesByStaticDb(config);
        this.serviceCrud = new byStaticDb_1.GmModuleServiceClassDeleteByNoSqlStaticDb(config, `this.${this.getServiceVarName()}`, {
            id: gmGetVarNames.delete().id,
            initiatorOpenUserId: gmGetVarNames.delete().openUserId,
        });
        this.gmAccessStructureMethodProcessorByStaticDb = new GmAccessStructureMethodProcessorByStaticDb(config);
...
exports.GmModuleControllerClassDeleteByNoSqlStaticDb = GmModuleControllerClassDeleteByNoSqlStaticDb;
class GmModuleControllerClassGetByNoSqlStaticDb extends GmModuleAbstractControllerClass_1.GmModuleAbstractControllerClass {
    constructor(config) {
        super(config, `Get${StringCaseHelper_1.StringCaseHelper.toPascalCase(config.dtoName.singular)}Controller`);
        const gmGetVarNames = new GmGetVarNamesByStaticDb(config);
        this.serviceCrud = new byStaticDb_1.GmModuleServiceClassGetByNoSqlStaticDb(config, `this.${this.getServiceVarName()}`, {
            id: gmGetVarNames.get().id,
        });
        this.gmAccessStructureMethodProcessorByStaticDb = new GmAccessStructureMethodProcessorByStaticDb(config);
        this.gmGetVarNames = gmGetVarNames;
...
exports.GmModuleControllerClassGetByNoSqlStaticDb = GmModuleControllerClassGetByNoSqlStaticDb;
class GmModuleControllerClassGetAllByNoSqlStaticDb extends GmModuleAbstractControllerClass_1.GmModuleAbstractControllerClass {
    constructor(config) {
        super(config, `GetAll${StringCaseHelper_1.StringCaseHelper.toPascalCase(config.dtoName.singular)}Controller`);
        this.validator = new GmModuleValidator_1.GmModuleValidator(config);
        this.gmValidatorBuilder = new GmValidatorBuilderByStaticDb(config, this.validator);
        const gmGetVarNames = new GmGetVarNamesByStaticDb(config);
        this.serviceCrud = new byStaticDb_1.GmModuleServiceClassGetAllByNoSqlStaticDb(config, `this.${this.getServiceVarName()}`, {
            params: gmGetVarNames.list().params,
        });
        this.gmAccessStructureMethodProcessorByStaticDb = new GmAccessStructureMethodProcessorByStaticDb(config);
        this.gmGetVarNames = gmGetVarNames;
...
exports.GmModuleControllerClassGetAllByNoSqlStaticDb = GmModuleControllerClassGetAllByNoSqlStaticDb;
