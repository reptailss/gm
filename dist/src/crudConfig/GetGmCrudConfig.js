...
exports.GetGmCrudConfig = void 0;
const path_1 = __importDefault(require("path"));
const gmCrudDefaultConfig_1 = require("./gmCrudDefaultConfig");
const GmCrudWriteDefaultConfig_1 = require("./GmCrudWriteDefaultConfig");
require("ts-node/register");
class GetGmCrudConfig {
    static async getConfig() {
        try {
            ...
            return gmCrudDefaultConfig_1.gmCrudDefaultConfig.default;
        }
        catch (error) {
            console.log(error, 'error import config');
            GmCrudWriteDefaultConfig_1.GmCrudWriteDefaultConfig.write();
            return gmCrudDefaultConfig_1.gmCrudDefaultConfig.default;
        }
    }
}
exports.GetGmCrudConfig = GetGmCrudConfig;
//# sourceMappingURL=GetGmCrudConfig.js.map