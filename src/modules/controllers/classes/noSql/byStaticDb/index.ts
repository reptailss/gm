...
import {
    GmModuleServiceClassCreateByNoSqlStaticDb,
    GmModuleServiceClassCrudByNoSqlStaticDb,
    GmModuleServiceClassDeleteByNoSqlStaticDb,
    GmModuleServiceClassGetAllByNoSqlStaticDb,
    GmModuleServiceClassGetByNoSqlStaticDb,
    GmModuleServiceClassUpdateByNoSqlStaticDb,
} from '@modules/services/classes/noSql/byStaticDb'
...
export class GmModuleControllerClassCrudByNoSqlStaticDb extends GmModuleAbstractControllerClass implements IGmModuleClass {
    
    
    private readonly validator: GmModuleValidator
    private readonly serviceCrud: GmModuleServiceClassCrudByNoSqlStaticDb
    private readonly gmGetVarNames: GmGetVarNamesByStaticDb
    ...
    constructor(config: GmCrudConfig,
        ...
        this.serviceCrud = new GmModuleServiceClassCrudByNoSqlStaticDb(
            config,
...
export class GmModuleControllerClassCreateByNoSqlStaticDb extends GmModuleAbstractControllerClass implements IGmModuleClass {
    
    
    private readonly validator: GmModuleValidator
    private readonly serviceCrud: GmModuleServiceClassCreateByNoSqlStaticDb
    private readonly gmGetVarNames: GmGetVarNamesByStaticDb
    private readonly gmAccessStructureMethodProcessorByStaticDb: GmAccessStructureMethodProcessorByStaticDb
    private readonly gmValidatorBuilder: GmValidatorBuilderByStaticDb
    ...
    constructor(config: GmCrudConfig,
        ...
        this.serviceCrud = new GmModuleServiceClassCreateByNoSqlStaticDb(
            config,
            `this.${this.getServiceVarName()}`,
            {
                createDto: gmGetVarNames.add().createBody,
...
export class GmModuleControllerClassUpdateByNoSqlStaticDb extends GmModuleAbstractControllerClass implements IGmModuleClass {
    
    
    private readonly validator: GmModuleValidator
    private readonly serviceCrud: GmModuleServiceClassUpdateByNoSqlStaticDb
    private readonly gmGetVarNames: GmGetVarNamesByStaticDb
    private readonly gmAccessStructureMethodProcessorByStaticDb: GmAccessStructureMethodProcessorByStaticDb
    private readonly gmValidatorBuilder: GmValidatorBuilderByStaticDb
    ...
    constructor(config: GmCrudConfig,
        ...
        this.serviceCrud = new GmModuleServiceClassUpdateByNoSqlStaticDb(
            config,
            `this.${this.getServiceVarName()}`,
            {
                id: gmGetVarNames.update().id,
...
export class GmModuleControllerClassDeleteByNoSqlStaticDb extends GmModuleAbstractControllerClass implements IGmModuleClass {
    
    private readonly serviceCrud: GmModuleServiceClassDeleteByNoSqlStaticDb
    private readonly gmGetVarNames: GmGetVarNamesByStaticDb
    private readonly gmAccessStructureMethodProcessorByStaticDb: GmAccessStructureMethodProcessorByStaticDb
    ...
    constructor(config: GmCrudConfig,
        ...
        const gmGetVarNames = new GmGetVarNamesByStaticDb(config)
        this.serviceCrud = new GmModuleServiceClassDeleteByNoSqlStaticDb(
            config,
            `this.${this.getServiceVarName()}`,
            {
                id: gmGetVarNames.delete().id,
...
export class GmModuleControllerClassGetByNoSqlStaticDb extends GmModuleAbstractControllerClass implements IGmModuleClass {
    
    private readonly serviceCrud: GmModuleServiceClassGetByNoSqlStaticDb
    private readonly gmGetVarNames: GmGetVarNamesByStaticDb
    private readonly gmAccessStructureMethodProcessorByStaticDb: GmAccessStructureMethodProcessorByStaticDb
    ...
    constructor(config: GmCrudConfig,
        ...
        const gmGetVarNames = new GmGetVarNamesByStaticDb(config)
        this.serviceCrud = new GmModuleServiceClassGetByNoSqlStaticDb(
            config,
            `this.${this.getServiceVarName()}`,
            {
                id: gmGetVarNames.get().id,
...
export class GmModuleControllerClassGetAllByNoSqlStaticDb extends GmModuleAbstractControllerClass implements IGmModuleClass {
    
    
    private readonly validator: GmModuleValidator
    private readonly serviceCrud: GmModuleServiceClassGetAllByNoSqlStaticDb
    private readonly gmGetVarNames: GmGetVarNamesByStaticDb
    private readonly gmAccessStructureMethodProcessorByStaticDb: GmAccessStructureMethodProcessorByStaticDb
    private readonly gmValidatorBuilder: GmValidatorBuilderByStaticDb
    ...
    constructor(config: GmCrudConfig,
        ...
        this.serviceCrud = new GmModuleServiceClassGetAllByNoSqlStaticDb(
            config,
            `this.${this.getServiceVarName()}`,
            {
                params: gmGetVarNames.list().params,
